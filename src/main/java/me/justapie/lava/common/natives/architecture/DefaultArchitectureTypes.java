...
public enum DefaultArchitectureTypes implements ArchitectureType
{
    ...
    private static Map<String, ArchitectureType> aliasMap;
    
    private DefaultArchitectureTypes(final String identifier, final List<String> aliases) {
    ...
    public static ArchitectureType detect() {
        ...
        final ArchitectureType type = DefaultArchitectureTypes.aliasMap.get(architectureName);
        if (type == null) {
    ...
    private static Map<String, ArchitectureType> createAliasMap() {
        final Map<String, ArchitectureType> aliases = new HashMap<String, ArchitectureType>();
        for (final DefaultArchitectureTypes value : values()) {
    ...
    static {
        DefaultArchitectureTypes.aliasMap = createAliasMap();
    }
}
